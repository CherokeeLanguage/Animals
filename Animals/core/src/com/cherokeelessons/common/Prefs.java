...
public class Prefs implements com.badlogic.gdx.Preferences {
	...
	public static enum Setting {
		ChallengeAudio, ChallengeMode, EffectsVolume, LevelAccuracy, LevelTime, MasterVolume, MusicVolume, TrainingMode, UUID, LeaderBoardEnabled		
	}
	...
	public TrainingMode getTrainingMode(){
		...
		TrainingMode mode=TrainingMode.Long;
		try {
